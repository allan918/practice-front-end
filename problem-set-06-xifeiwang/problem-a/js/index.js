...
console.log(EXAMPLE_SEARCH_RESULTS);

function togglerSpinner() {
  var spin = document.querySelector(".fa-spinner");
...
function renderTrack(object) {
  ...
  elements.src = object.artworkUrl100;
  elements.alt = object.trackName;
  elements.title = object.trackName;
  records.appendChild(elements);
}
...
console.log("worked");
  ...
  return fetch(URL_TEMPLATE.replace("{searchTerm}", search)).then(
